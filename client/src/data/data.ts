export const products = [
  ...
  },
  {
    ...
    description:
      "Miraclin Implant unfolds all-round protection and supports the regeneration of damaged cells along the implants. It also prevents gum recess, protects the implant from external influences and maintains its intended strength.",
  },
  {
    name: "Yasmin",
    price: "$49.99",
    ...
    description:
      "Yasmin is a contraceptive pill and is used to prevent pregnancy. Each film-coated tablet contains a small amount of two different female hormones, namely drospirenone and ethinylestradiol. Contraceptive pills that contain two hormones are called “combination” pills.",
  },
  {
  ...
  },
  {
    ...
    availability: "In Stock",
    imageUrl:
      "https://media.licdn.com/dms/image/v2/C4E03AQGg5g6Um6nEuQ/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1651492215535?e=1730937600&v=beta&t=wPCKfkLyITtTOgiBYGwX2lAXylFUd0h14t_ZLFi1VyU",
  ...
  },
  {
    ...
    availability: "In Stock",
    imageUrl:
      "https://media.licdn.com/dms/image/v2/D4E03AQFNSF9YfrVJww/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1714575185487?e=1730937600&v=beta&t=Q4Ysrj_f6dw26uDU2XSTNRoJfi_47IVEoZ1XZNlZZXk",
